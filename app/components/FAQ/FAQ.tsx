...
export default function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Переводом на карту, СБП или по договорённости. Мы принимаем различные способы оплаты для вашего удобства.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Spotify, Netflix, iCloud, Google One, Notion, GitHub, Steam, домены и хостинг, а также любые другие зарубежные сервисы.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Свяжитесь с нами в Telegram @AltPayBot. Мы решим проблему и вернем деньги, если что-то пойдет не так.'
    }
  ];
